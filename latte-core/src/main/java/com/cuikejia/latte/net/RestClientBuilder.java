 ...
 * 建造者模式 RestClientBuilder和RestClient
 */

public class RestClientBuilder {
    private String mUrl = null;
    private static final Map<String, Object> PARAMS = RestCreator.getParams();
    private IResquest mRequest = null;
    ...
    public final RestClientBuilder request(IResquest request) {
    ...
    public final RestClientBuilder dir(String download) {
        this.mDownloadDir = download;
        return this;
    }
